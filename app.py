...
def index2():
    ...
    72, 76, 80, 84, 88, 92, 99, 100, # Level 4
    70, 72, 74, 76, 78, 80, 82, 84, 86, 88, 90, 92, 94, 99, 98, 100, # Level 5
    69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84,
    85, 86, 87, 88, 89, 90, 91, 92, 93, 94, 95, 99, 33, 98, 97, 100 # Level 6
    ]
    tree_data = level_to_preorder(tree_data)
    return render_template('index.html', tree_data=tree_data)
...
def index6():
    ...
    tree_data = [
        ...
        71, 75, 79, 250, 87, 91, 95, 300,  # Level 4
        69, 71, 73, 75, 77, 79, 81, 250, 85, 87, 89, 91, 93, 95, 279, 300,  # Level 5
        68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 250, 
        84, 85, 86, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 279, 98, 300  # Level 6
    ]
    tree_data = level_to_preorder(tree_data)
    return render_template('index.html', tree_data=tree_data)
...
def index7():
    ...
    tree_data = [
        ...
        75, 250, 91, 300,    # Level 3
        71, 75, 79, 250, 87, 91, 95, 300,  # Level 4
        69, 71, 73, 75, 77, 79, 81, 250, 85, 87, 89, 91, 93, 95, 288, 300,  # Level 5
        68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 250, 
        84, 85, 86, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 288, 98, 300  # Level 6
    ]
    tree_data = level_to_preorder(tree_data)
    return render_template('index.html', tree_data=tree_data)
